...
# parser.add_argument('-start', action="store", default=MIN_START_YEAR, dest="start_year", type=int, help='The start year to scrap the papers')
# parser.add_argument('-end', action="store", default=MAX_END_YEAR, dest="end_year", type=int, help='The end year to scrap the papers')
# arguments = parser.parse_args()


# # Argparse conditions
# if arguments.start_year < MIN_START_YEAR or arguments.start_year > MAX_END_YEAR:
#     raise ValueError("Please enter a valid start year. Possible values are [1987, 2019].")

# if arguments.end_year < MIN_START_YEAR or arguments.end_year > MAX_END_YEAR:
...
def get_conference_url(start_year: int, end_year: int):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for author in doc["authors"]:
                    ...
                    author_details["institution"] = (
                        author["institution"] if author["institution"] else None
                    )
...
if __name__ == "__main__":
    conferences = get_conference_url(start_year=2017, end_year=2017)
